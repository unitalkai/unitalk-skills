---
name: plan
description: Creates detailed, actionable markdown plans saved to .hermes/plans/ — bite-sized tasks with exact file paths and code. Use for implementation planning before coding begins.
version: 2.0.0
